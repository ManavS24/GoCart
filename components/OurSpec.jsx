...
const OurSpecs = () => {
    ...
    return (
        <div className='px-6 my-20 max-w-6xl mx-auto'>
            <Title visibleButton={false} title='Why shop here' description="A small marketplace built on approved sellers, honest pricing and a checkout that hands payment straight to Razorpay." />
